...
async function buildApp(config) {
    ...
    const kafka = new kafka_client_1.KafkaEventBus({ brokers: config.kafkaBrokers, clientId: config.kafkaClientId });
    ...
    const playlistService = new services_1.PlaylistService(kafka);
    await (0, routes_1.registerPlaylistRoutes)(app, playlistService);
